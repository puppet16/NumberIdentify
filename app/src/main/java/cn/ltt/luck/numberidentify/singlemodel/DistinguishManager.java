...
public class DistinguishManager {
    private static final String LOG_TAG = DistinguishManager.class.getSimpleName();

    private static final String MODEL_NAME = "num_cnn3_0.4.tflite";//"mnist.tflite";
    ...
    public DistinguishManager(Activity activity) throws IOException {
    ...
    public DistinguishResult classify(Bitmap bitmap) {
        ...
        return new DistinguishResult(mResult[0], timeCost);
    }
